...
import 'package:shop_app_2/modules/Shop_App/login/cubit/cubit.dart';
import 'package:shop_app_2/modules/Shop_App/login/cubit/status.dart';
import 'package:shop_app_2/modules/Shop_App/register/shop_register_Screen.dart';
        ...
        listener: (BuildContext context, state) {
          if (state is ShopLoginSuccessState) {
            ...
            navigateAndFinish(context, ShopLayout());
              CacheHelper.saveData(key: 'isAuth',value: 'auth');
